...
<div style="margin-bottom: 1rem;">
  <a href="{{ route('products.create') }}" class="btn btn-dark">ADD NOVO PRODUTO <i class="fas fa-plus-square"></i></a>
</div>
  ...
  <div class="card-body">
    <table class="table table-condensed">
      ...
      <tbody>
        ...
        <tr>
          <td>
            <img src="{{ url("storage/{$product->image}") }}" alt="{{ $product->title }}" width="100">
          </td>
          <td>
            {{ $product->title }}
          </td>
