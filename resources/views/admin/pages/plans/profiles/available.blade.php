...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item"><a href="{{ route('plans.profiles.available', $plan->id) }}" class="active">Disponíveis</a></li>
</ol>
<h1 class="my-3">Perfis disponíveis para o plano <b>{{ $plan->name }}</b></h1>
@stop
