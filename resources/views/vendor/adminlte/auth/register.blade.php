...
<form action="{{ $register_url }}" method="post">
    ...
    <div class="input-group mb-3">
        <input type="text" name="empresa" class="form-control @error('empresa') is-invalid @enderror" value="{{ old('empresa') }}" placeholder="Empresa" autofocus>
    ...
    {{-- CNPJ field --}}
    <div class="input-group mb-3">
        <input type="text" name="cnpj" class="form-control @error('cnpj') is-invalid @enderror" value="{{ old('cnpj') }}" placeholder="cnpj" autofocus>
