...
class OrderService
{
  ...
  /******************************************************************************************************
   * GET PEDIDOS pelo identificador do pedido
   */
  ...
  {
    //str_shuffle pega string minusculas e embaralha
    ...
    //Verifica se o valor do pedido existe 
    //Caso exista chama de novo e gera novo codigo
  ...
  /******************************************************************************************************
   * GET dados dos produtos pedidos 
   * na ordem de serviço
   */
  ...
  /**********************************************************************************************
   * GET ID Table 
   * Caso o pedido seja feito online,
   * não retorna mesa
   */
  ...
  /**********************************************************************************************
   * GET ID do cliente que fez o pedido.
   * Caso não seja cadastrado retorna vazio
   */
