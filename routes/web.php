...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::post('products/{id}/categories', 'CategoryProductController@attachcategoriesProfile')->name('products.categories.attach');
        ...
        /**
         * Route Planos x Permissions
         */
        Route::get('plans/{id}/profile/{idProfile}/detach', 'ACL\PlanProfileController@detachPlanProfiles')->name('plans.profile.detach');
 ...
 * Auth Routes
 */
//Auth::routes(['register' => false]); Desabilita a opção do usuario se registrar no sistema
Auth::routes();
